...
//     glfwSetKeyCallback(Platform::getWindow().getGLFWWindow(), InputHandler::key_callback);
//     glfwSetMouseButtonCallback(Platform::getWindow().getGLFWWindow(), InputHandler::mouse_callback);
//     glfwSetCursorPosCallback(Platform::getWindow().getGLFWWindow(), InputHandler::cursor_callback);
//     glfwSetScrollCallback(Platform::getWindow().getGLFWWindow(), InputHandler::scroll_callback);
//     glfwSetFramebufferSizeCallback(Platform::getWindow().getGLFWWindow(), InputHandler::windowSize_callback);
...
//     PushState &b = MOUSEBUTTON[button];
//     if (action == GLFW_PRESS) {
//         if (b.isDown == false) {
//             b.isPressed = true;
